...
def admin_home(request):
    return render(request, 'karate/admin_home.html')
...
def student_details(request):
    if request.method == 'POST':
        ...
        if 'search' in request.POST:
            ...
            return render(request, 'karate/Student/student_details.html', {'students': students, 'query': search})
            ...
            return render(request, 'karate/Student/student_details.html', {'students': students})
            ...
            if rank == '--select--':
                ...
                form_rank += rank
            return render(request, 'karate/Student/student_details.html', {'students': students, 'form_parent': is_p, 'form_rank': form_rank})
    else:
        if request.user.is_authenticated:
            students = Student.objects.all()
        else:
            students = GuestStudent.objects.all()
        return render(request, 'karate/Student/student_details.html', {'students': students, 'form_parent': None, 'form_rank': None})
...
def parent_details(request):
    if request.method == 'POST':
        if 'search' in request.POST:
            search = request.POST['search']
            if request.user.is_authenticated:
                parents = Parent.objects.filter(first_name__icontains=search) | Parent.objects.filter(last_name__icontains=search) | Parent.objects.filter(email__icontains=search) | Parent.objects.filter(street_name__icontains=search) | Parent.objects.filter(city__icontains=search) | Parent.objects.filter(province__icontains=search)
            else:
                parents = GuestParent.objects.filter(first_name__icontains=search) | GuestParent.objects.filter(last_name__icontains=search) | GuestParent.objects.filter(email__icontains=search) | GuestParent.objects.filter(street_name__icontains=search) | GuestParent.objects.filter(city__icontains=search) | GuestParent.objects.filter(province__icontains=search)
            return render(request, 'karate/Parent/parent_details.html', {'parents': parents, 'query': search})
        elif 'sort_factor' in request.POST:
            sort_factor = request.POST['sort_factor']
            if 'sort_order' in request.POST:
                sort_order = request.POST['sort_order']
            ...
            if sort_order == 'Descending':
                ...
                parents = parents.order_by(sort_factor)
            return render(request, 'karate/Parent/parent_details.html', {'parents': parents, 'sort':sort_factor + sort_order})
        else:
            if request.user.is_authenticated:
                parents = Parent.objects.all()
            else:
                parents = GuestParent.objects.all()
            return render(request, 'karate/Parent/parent_details.html', {'parents': parents})
    else:
        if request.user.is_authenticated:
            parents = Parent.objects.all()
        else:
...
def class_details(request):
    if request.method == 'POST':
        ...
        if 'search' in request.POST:
            ...
            return render(request, 'karate/Class/class_details.html', {'classes': classes, 'query': search})
        elif 'sort_factor' in request.POST:
            sort_factor = request.POST['sort_factor']
            if request.user.is_authenticated:
            ...
            return render(request, 'karate/Class/class_details.html',
                          {'classes': classes, 'sort': sort_factor + sort_order})
        else:
            if request.user.is_authenticated:
                classes = Class.objects.all()
            else:
                classes = GuestClass.objects.all()
            return render(request, 'karate/Class/class_details.html', {'classes': classes})
    else:
        if request.user.is_authenticated:
            classes = Class.objects.all()
        else:
...
def attendance_details(request):
    ...
    if request.method == 'POST':
        ...
        if 'search' in request.POST:
            ...
            return render(request, 'karate/Attendance/attendance_details.html', {'records': records, 'query': rank})
...
def progress_details(request):
    ...
    if request.method == 'POST':
        if 'search' in request.POST:
            ...
            return render(request, 'karate/Progress/progress_details.html', {'records': records, 'query': rank})
        elif 'start_date' in request.POST:
            start_date = request.POST['start_date']
            if 'end_date' in request.POST:
                end_date = request.POST['end_date']
...
def payment_details(request):
    ...
    if request.method == 'POST':
        if 'fee_type' in request.POST:
            ...
            return render(request, 'karate/Payment/payment_details.html', {'records': records})
        if 'search' in request.POST:
            search = request.POST['search']
            if request.user.is_authenticated:
            ...
            return render(request, 'karate/Payment/payment_details.html', {'records': records, 'query': search})
        elif 'start_date' in request.POST:
            start_date = request.POST['start_date']
            if 'end_date' in request.POST:
                end_date = request.POST['end_date']
        ...
        return render(request, 'karate/Payment/payment_details.html', {'records': records, 'form_parent': None, 'form_rank': None})
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if student.is_parent == 'Yes':
                ...
                return render(request, 'karate/Student/student_register_done.html', {'name': student.first_name + " " + student.last_name, 'parent_id': par.id})
            else:
                return render(request, 'karate/Student/student_register_done.html', {'name': student.first_name + " " + student.last_name})
        else:
        ...
        if request.user.is_authenticated:
            ...
            form = GuestStudentForm()
        return render(request, 'karate/Student/student_register.html', {'form': form})
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if parent.student is None:
                return render(request, 'karate/Student/parent_check.html', {'error': "Note: You must select a student", 'form': form})
            else:
                parent.save()
                return render(request, 'karate/Student/parent_record_inserted.html', {'parent': parent.first_name})
        else:
            return render(request, 'karate/Student/parent_check.html', {'error': "Note: You must select a student", 'form': form})
    else:
        if request.user.is_authenticated:
        ...
        return render(request, 'karate/Student/parent_check.html', {'form': form})
...
def parent_register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            parent = form.save(commit=False)
            return render(request, 'karate/Parent/parent_register_done.html', {'name': parent.first_name + " " + parent.last_name})
    else:
        if request.user.is_authenticated:
            form = ParentForm()
        else:
            form = GuestParentForm()
        return render(request, 'karate/Parent/parent_register.html', {'form': form})
...
def class_register(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            form = GuestClassForm()
        return render(request, 'karate/Class/class_register.html', {'form': form})
...
def attendance_register(request):
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return render(request, 'karate/Attendance/attendance_register_done.html', {'name': "Attendance taken on " + str(attendance_form.date_taken) + " for class" })
        else:
            if request.user.is_authenticated:
                form = AttendanceForm()
            else:
                form = GuestAttendanceForm()
            return render(request, 'karate/Attendance/attendance_register.html', {'form': form})
...
def progress_register(request):
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return render(request, 'karate/Progress/progress_register_done.html', {'name': progress_form.student.first_name +'\'s' })
        else:
            if request.user.is_authenticated:
                form = ProgressForm()
            else:
                form = GuestProgressForm()
            return render(request, 'karate/Progress/progress_register.html', {'form': form})
...
def payment_register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'karate/Payment/payment_register_done.html', {'name': payment_form.student.first_name +'\'s' })
    else:
        if request.user.is_authenticated:
            form = PaymentForm()
        else:
...
def student_edit(request, student_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'karate/Student/student_edit_done.html', {'form': form, 'student':student})
    else:
        if request.user.is_authenticated:
            form = StudentForm(instance=student)
        else:
            form = GuestStudentForm(instance=student)
        return render(request, 'karate/Student/student_edit.html', {'form': form, 'student': student})
...
def parent_edit(request, parent_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save(commit=True)
            return render(request, 'karate/Parent/parent_edit_done.html', {'form': form})
    else:
        if request.user.is_authenticated:
            form = ParentForm(instance=parent)
        else:
            form = GuestParentForm(instance=parent)
        return render(request, 'karate/Parent/parent_edit.html', {'form': form, 'parent': parent})
...
def class_edit(request, class_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save(commit=True)
            return render(request, 'karate/Class/class_edit_done.html', {'form': form})
    else:
        if request.user.is_authenticated:
            form = ClassForm(instance=class_record)
        else:
            form = GuestClassForm(instance=class_record)
        return render(request, 'karate/Class/class_edit.html', {'form': form, 'class_record': class_record})
...
def attendance_edit(request, attendance_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save(commit=True)
            return render(request, 'karate/Attendance/attendance_edit_done.html', {'form': form})
    else:
        if request.user.is_authenticated:
            form = AttendanceForm(instance=attendance_record)
        else:
            form = GuestAttendanceForm(instance=attendance_record)
        return render(request, 'karate/Attendance/attendance_edit.html', {'form': form, 'attendance_record': attendance_record})
...
def progress_edit(request, progress_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save(commit=True)
            return render(request, 'karate/Progress/progress_edit_done.html', {'form': form})
    else:
        if request.user.is_authenticated:
            form = ProgressForm(instance=progress_record)
        else:
            form = GuestProgressForm(instance=progress_record)
        return render(request, 'karate/Progress/progress_edit.html', {'form': form, 'progress_record': progress_record})
...
def payment_edit(request, payment_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save(commit=True)
            return render(request, 'karate/Payment/payment_edit_done.html', {'form': form})
    else:
        if request.user.is_authenticated:
            form = PaymentForm(instance=payment_record)
        else:
            form = GuestPaymentForm(instance=payment_record)
        return render(request, 'karate/Payment/payment_edit.html', {'form': form, 'payment_record': payment_record})
...
def student_delete(request, student_id):
    if request.method == 'POST':
        ...
        student.delete()
        return render(request, 'karate/Student/student_delete_done.html', {'name': name})
    else:
        return render(request, 'karate/Student/student_delete.html', {'student_id': student_id})
...
def parent_delete(request, parent_id):
    if request.method == 'POST':
        ...
        parent.delete()
        return render(request, 'karate/Parent/parent_delete_done.html', {'name': name})
    else:
        return render(request, 'karate/Parent/parent_delete.html', {'parent_id': parent_id})
...
def class_delete(request, class_id):
    if request.method == 'POST':
        ...
        class_record.delete()
        return render(request, 'karate/Class/class_delete_done.html', {'name': name})
    else:
        return render(request, 'karate/Class/class_delete.html', {'class_id': class_id})
...
def attendance_delete(request, attendance_id):
    if request.method == 'POST':
        ...
        return render(request, 'karate/Attendance/attendance_delete_done.html', {'date': date_taken, 'id': id})
    else:
        return render(request, 'karate/Attendance/attendance_delete.html', {'attendance_id': attendance_id})
...
def progress_delete(request, progress_id):
    if request.method == 'POST':
        ...
        return render(request, 'karate/Progress/progress_delete_done.html', {'name': name, 'rank': rank})
    else:
        return render(request, 'karate/Progress/progress_delete.html', {'progress_id': progress_id})
...
def payment_delete(request, payment_id):
    if request.method == 'POST':
        ...
        return render(request, 'karate/Payment/payment_delete_done.html', {'name': name, 'fee_type': fee_type, 'paid_date': paid_date})
    else:
        return render(request, 'karate/Payment/payment_delete.html', {'payment_id': payment_id})